            ...
            <div className='content md:px-20 px-10'>
                <div className="flexAlign contentPage">
                    <div className='flexCol'>
                        <span className='headArticleDonait flex'>دونیت چیست</span>
                ...
                <h1 className='headerArticles flexAlign'>دونیت چیست</h1>
                <p>
                ...
                <h1 className='headerArticles flexAlign'>پرتوک چیست</h1>
